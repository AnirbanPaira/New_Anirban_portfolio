  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="-mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-[500px] xl:h-[600px]"
      />
      <div className="space-y-10 px-0 md:px-10">
        ...
        <p className="text-base">
          ...
          Currently excelling at Yoctotta Pvt Ltd., I'm fueled by a passion for
          crafting intuitive user interfaces and solving intricate coding
          challenges. As I navigate my career, I'm eagerly seeking a new
          challenge—a role that not only leverages my skills but also encourages
          continuous growth and innovation. I'm driven to contribute my
          expertise to a dynamic team dedicated to pushing boundaries and
