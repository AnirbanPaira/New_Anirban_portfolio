  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="-mb-20 md:mb-0 flex-shrink-0 w-36 h-36 rounded-full object-cover md:rounded-lg md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-[500px] xl:h-[500px] relative top-36 lg:top-0 md:top-0"
      ...
      <div className="space-y-6 md:space-y-10 px-0 md:px-10 mt-auto lg:mt-0 md:mt-0">
        <h4 className="text-xl md:text-2xl lg:text-3xl font-semibold pt-10">
          Here is a
          <span
            className="underline"
